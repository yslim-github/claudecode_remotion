...
export const SCENES: SceneItem[] = [
  ...
  },
  {
    ...
    subtitle: `Open Design의 핵심 질문: AI 디자인 도구를 내 로컬 환경에서, 내가 원하는 에이전트로 쓸 수 없을까?`,
    visualType: "compare",
    visualData: {
  ...
  },
  {
    ...
    visualData: {
      ...
      cards: [
        ...
        { icon: "🎨", title: "Design Systems", desc: "일관된 결과물" },
        { icon: "📤", title: "다양한 내보내기", desc: "HTML·PDF·PPTX·ZIP" },
        { icon: "🛠️", title: "Skills 확장", desc: "커스텀 스킬 추가" },
      ],
    },
  },
  {
    ...
    visualData: {
      header: "⚠️ 주의사항",
      accent: "#FF7B72",
      items: ["Node·pnpm 버전 호환성 확인", "에이전트 CLI PATH 설정", "native dependency 문제", "AI 결과물 사람이 검수 필수", "브랜드·저작권 확인"],
    },
  },
  {
    id: 18,
    ...
    visualData: {
      ...
      cols: 2,
      cards: [
        { icon: "🚀", title: "스타트업 창업자", desc: "피치덱 빠른 초안" },
